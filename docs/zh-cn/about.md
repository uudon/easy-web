...
| 语言 | 适合场景 |
|------|---------|
| Java | 企业级系统开发，稳定、成熟，社区和生态都很完善 |
| Kotlin | 现代 Android 开发，在保持 Java 生态兼容性的同时，让代码更加安全、简洁 |
| C/C++ | 更接近硬件和操作系统，适合单片机、嵌入式系统以及对性能要求很高的场景 |
| Python | 算法、人工智能、数据处理和数学计算方面有明显优势，适合快速验证想法 |
...
| 以前（开发视角） | 现在（管理视角） |
|----------------|----------------|
| 这个功能能不能实现 | 这个功能应不应该现在实现 |
| 关心代码是否正确 | 关心目标是否明确、需求是否完整、资源是否足够、风险是否可控、上线时间是否合理 |
| 思考如何开发 | 判断价值、优先级、影响范围和投入成本 |
